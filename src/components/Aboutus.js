    ...
    <div className="container" style={darkMode}>
        ...
        <div className="container my-1 " >
            <div className="form-check form-switch">
                <input className="form-check-input" type="checkbox" id="flexSwitchCheckDefault" onClick={toggelStyle}/>
                <label className="form-check-label" htmlFor="flexSwitchCheckDefault">{btnText}</label>
            </div>
        {/* <button type="button" className="btn   my-3" style={btnColor} onClick={toggelStyle}>{btnText}</button> */}
        </div>
